...
return new class extends Migration
{
    ...
    {
        Schema::create('appeal__appeal_them_groups', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('appeal__appeal_thems', function (Blueprint $table) {
            $table->id();

            $table->string('name');
            $table->foreignId('group_id')->constrained(AppealThemGroup::getTableName());
        ...
        Schema::create('appeal__appeals', function (Blueprint $table) {
            ...
            $table->foreignId('them_id')->constrained(AppealThem::getTableName());
        ...
        Schema::create('appeal__message_file', function (Blueprint $table) {
            $table->id();

            $table->foreignId('message_id')->constrained(AppealMessage::getTableName());
    ...
    {
        Schema::dropIfExists('appeal__message_file');
        Schema::dropIfExists('appeal__messages');
        Schema::dropIfExists('appeal__appeals');
        Schema::dropIfExists('appeal__statuses');
        Schema::dropIfExists('appeal__appeal_thems');
        Schema::dropIfExists('appeal__appeal_them_groups');
    }
};
