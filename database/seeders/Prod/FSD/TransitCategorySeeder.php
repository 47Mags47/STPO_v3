...
class TransitCategorySeeder extends Seeder
{
    ...
    {
        TransitCategory::create(['id' => 1,     'wp_kat_id' => NULL,   'name' => 'Пенсионеры']);
        TransitCategory::create(['id' => 2,     'wp_kat_id' => 1,      'name' => 'Ветераны труда']);
        TransitCategory::create(['id' => 3,     'wp_kat_id' => 2,      'name' => 'Труженики тыла']);
        TransitCategory::create(['id' => 4,     'wp_kat_id' => 3,      'name' => 'Реабилитированные лица и лица, пострадавшие от политических репрессий']);
        TransitCategory::create(['id' => 5,     'wp_kat_id' => 4,      'name' => 'Пострадавшие']);
        TransitCategory::create(['id' => 6,     'wp_kat_id' => 5,      'name' => 'Многодетные матери']);
        TransitCategory::create(['id' => 7,     'wp_kat_id' => 6,      'name' => 'Отдельных категорий приемных родителей']);
        // ?
        TransitCategory::create(['id' => 8,     'wp_kat_id' => 7,      'name' => 'Отдельные категории граждан (Герои Кузбасса, почетные граждане КО, медали «За особый вклад в развитие Кузбасса трёх степеней»)']);
        TransitCategory::create(['id' => 9,     'wp_kat_id' => 8,      'name' => 'Инвалиды']);
        TransitCategory::create(['id' => 10,    'wp_kat_id' => 9,      'name' => 'Дети-инвалиды']);
        TransitCategory::create(['id' => 11,    'wp_kat_id' => 10,     'name' => 'Инвалиды ВОВ']);
        TransitCategory::create(['id' => 12,    'wp_kat_id' => 11,     'name' => 'Участники войны']);                               // ?
        TransitCategory::create(['id' => 13,    'wp_kat_id' => 12,     'name' => 'Жители блокадного Ленинграда']);
        TransitCategory::create(['id' => 14,    'wp_kat_id' => 13,     'name' => 'Бывшие несовершеннолетние узники концлагерей']);
        TransitCategory::create(['id' => 15,    'wp_kat_id' => 14,     'name' => 'Члены семей погибших (умерших) граждан ВОВ']);    // ?
        TransitCategory::create(['id' => 16,    'wp_kat_id' => 15,     'name' => 'Ветеран ст. 17']);                                // ?
        TransitCategory::create(['id' => 17,    'wp_kat_id' => 16,     'name' => 'Ветераны б/д']);
        TransitCategory::create(['id' => 18,    'wp_kat_id' => 17,     'name' => 'Лица, подвергшиеся воздействию радиации']);
        TransitCategory::create(['id' => 19,    'wp_kat_id' => 18,     'name' => 'Ветераны ВОВ ст. 19']);
        TransitCategory::create(['id' => 20,    'wp_kat_id' => 19,     'name' => 'Герои РФ, герои СССР, ПК ордена Славы, герои соц. труда, орден славы трёх степеней']);
